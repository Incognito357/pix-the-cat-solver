...
public class GridTest {
    ...
    public void testOps() {
        ...
        assertThat(grid.getRow(0)).containsExactly(0, 1, 2, 3);

        grid.addRow(list(4, 5, 6, 7));
        assertThat(grid.getHeight()).isEqualTo(2);
        assertThat(grid.getWidth()).isEqualTo(4);
        assertThat(grid.getRow(1)).containsExactly(4, 5, 6, 7);

        grid.removeColumn();
        assertThat(grid.getHeight()).isEqualTo(2);
        assertThat(grid.getWidth()).isEqualTo(3);
        assertThat(grid.getRow(0)).containsExactly(0, 1, 2);
        assertThat(grid.getRow(1)).containsExactly(4, 5, 6);

        grid.removeColumn();
        assertThat(grid.getHeight()).isEqualTo(2);
        assertThat(grid.getWidth()).isEqualTo(2);
        assertThat(grid.getRow(0)).containsExactly(0, 1);
        assertThat(grid.getRow(1)).containsExactly(4, 5);
